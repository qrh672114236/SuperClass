...
Java_com_example_superclass_media_ffmpeg_Fplayer_native_1statr(JNIEnv *env, jobject instance,
...
Java_com_example_superclass_media_ffmpeg_Fplayer_test(JNIEnv *env, jobject instance) {
